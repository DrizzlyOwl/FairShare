...
const STATIC_ASSETS = [
    './',
    './index.html?v=1772210700',
    './style.css?v=1772210700',
    './src/main.js?v=1772210700',
    './src/core/State.js',
    ...
    './logo-icon.svg?v=1772210700',
    './logo-icon-dark.svg?v=1772210700',
    './favicon.svg?v=1772210700',
    './manifest.json',
