...
const STATIC_ASSETS = [
    './',
    './index.html?v=1772557563',
    './style.css?v=1772557563',
    './src/main.js?v=1772557563',
    './src/core/State.js',
    ...
    './logo-icon.svg?v=1772557563',
    './logo-icon-dark.svg?v=1772557563',
    './favicon.svg?v=1772557563',
    './manifest.json',
                    ...
                    return Promise.all(
                        requests.map(request => {
                            ...
                            const isCurrentAsset = STATIC_ASSETS.some(asset => {
                                ...
                                // Match with query string (e.g., './style.css?v=1772557563')
