...
const STATIC_ASSETS = [
    './',
    './index.html?v=1772206328',
    './style.css?v=1772206328',
    './src/main.js?v=1772206328',
    './src/core/State.js',
    ...
    './logo-icon.svg?v=1772206328',
    './logo-icon-dark.svg?v=1772206328',
    './favicon.svg?v=1772206328',
    './manifest.json',
