...
const STATIC_ASSETS = [
    './',
    './index.html?v=1772207510',
    './style.css?v=1772207510',
    './src/main.js?v=1772207510',
    './src/core/State.js',
    ...
    './logo-icon.svg?v=1772207510',
    './logo-icon-dark.svg?v=1772207510',
    './favicon.svg?v=1772207510',
    './manifest.json',
                    ...
                    return Promise.all(
                        requests.map(request => {
                            ...
                            const isCurrentAsset = STATIC_ASSETS.some(asset => {
                                ...
                                // Match with query string (e.g., './style.css?v=1772207510')
